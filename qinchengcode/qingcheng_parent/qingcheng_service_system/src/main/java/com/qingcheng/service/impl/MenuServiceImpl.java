...
public class MenuServiceImpl implements MenuService {
    ...
    public List<Map> findAllMenu() {
        ...
        List<Menu> meunList = findAll();


        return findMeunListByParentrId(meunList,"0");
    }
     ...
     * @return
     */
    private List<Map> findMeunListByParentrId(List<Menu> menuList,String parentId){
        ...
        for (Menu menu : menuList) {
            if (menu.getParentId().equals(parentId)){
                ...
                map.put("children",findMeunListByParentrId(menuList,menu.getId()));
                mapList.add(map);
            }
        }
        return mapList;
