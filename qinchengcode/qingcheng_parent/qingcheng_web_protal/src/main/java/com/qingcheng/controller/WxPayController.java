...
public class WxPayController {
    ...
    public Map createNative(String orderId) throws Exception {
        ...
        if (order!=null){
            if (order.getOrderStatus().equals("0")&&order.getPayStatus().equals("0")&&order.getUsername().equals(userName)){
                return  wxPayService.createNative(orderId, order.getPayMoney(), "http://1b7mt1r.nat.ipyingshe.com/wxpay/notify.do");
            }
        }else {
            return null;
        }
